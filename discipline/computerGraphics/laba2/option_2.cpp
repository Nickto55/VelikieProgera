...
void deistvie(int chto_delaem, int size[], double *mass, double var[]) {
    if (chto_delaem != -1) {
        double mat[3][3];
        int size_mat[2] = {3, 3};
        double res[4][4]; // Максимум 4 точки
        double center[4] = {0, 0, 1, 1};
        ...
        mat[2][0] = -center[0]; mat[2][1] = -center[1]; mat[2][2] = 1; mat[2][3] = 0;
        ...
        if (chto_delaem == 0) { // Сдвиг
            mat[0][0] = 1; mat[0][1] = 0; mat[0][2] = 0; mat[0][3] = 0;
            mat[1][0] = 0; mat[1][1] = 1; mat[1][2] = 0; mat[1][3] = 0;
            mat[2][0] = var[0]; mat[2][1] = var[1]; mat[2][2] = 1; mat[2][3] = 0;
        }
        else if (chto_delaem == 1) { // Масштабирование
            mat[0][0] = var[0]; mat[0][1] = 0; mat[0][2] = 0; mat[0][3] = 0;
            mat[1][0] = 0; mat[1][1] = var[1]; mat[1][2] = 0; mat[1][3] = 0;
            mat[2][0] = 0; mat[2][1] = 0; mat[2][2] = 1; mat[2][3] = 0;
        }
        else if (chto_delaem == 2) { // Поворот
            double angle = var[0];
            mat[0][0] = cos(angle); mat[0][1] = sin(angle); mat[0][2] = 0; mat[0][3] = 0;
            mat[1][0] = -sin(angle); mat[1][1] = cos(angle); mat[1][2] = 0; mat[1][3] = 0;
            mat[2][0] = 0; mat[2][1] = 0; mat[2][2] = 1; mat[2][3] = 0;
        }
...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
    ...
    // Рисуем все 4 стороны
    bresenhamLine(hdc, risunok[0][0], risunok[0][1], risunok[1][0], risunok[1][1], RGB(255, 0, 0)); // Красный
    bresenhamLine(hdc, risunok[1][0], risunok[1][1], risunok[2][0], risunok[2][1], RGB(0, 255, 0)); // Зеленый
    bresenhamLine(hdc, risunok[2][0], risunok[2][1], risunok[3][0], risunok[3][1], RGB(0, 0, 255)); // Синий
    bresenhamLine(hdc, risunok[3][0], risunok[3][1], risunok[0][0], risunok[0][1], RGB(255, 255, 0));// Желтый
